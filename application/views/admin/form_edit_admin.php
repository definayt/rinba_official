      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-body">
                <form id="form_tambah_pegawai" method="POST" enctype="multipart/form-data" action="<?php echo base_url('Admin/proses_edit/')?>">
                 <input type="hidden" name="id_admin" value="<?= $data_admin->id_petugas?>">
                  ...
                  <div class="input-group form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Nama Admin" name="nama_admin" aria-describedby="sizing-addon2" value="<?= $data_admin->nama_petugas?>" required>
                  </div>
                  ...
                  <div class="input-group form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Username" name="username" aria-describedby="sizing-addon2" value="<?= $data_admin->username?>"required>
                  </div>
                  <div class="row mb-2 ">
                    <div class="col-sm-3 ">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
              <h5 class="modal-title" id="myModalLabel">Anda yakin ingin membatalkan perubahan Data Admin?</h5>
          </div>
