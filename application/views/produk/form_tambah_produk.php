      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-body">
                <form id="form_tambah_pegawai" method="POST" enctype="multipart/form-data" action="<?php echo base_url('Produk/proses_tambah/')?>" enctype="multipart/form-data">
                  ...
                  <div class="input-group form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Nama Produk" name="nama_produk" aria-describedby="sizing-addon2"  required>
                  </div>
                  ...
                  <div class="input-group form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Deskripsi Produk" name="deskripsi_produk" aria-describedby="sizing-addon2" required>
                  </div>
                  ...
                  <div class="input-group form-group">
                    ...
                    <input type="number" class="form-control" placeholder="Harga" name="harga" aria-describedby="sizing-addon2" required>
                  </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
              <h5 class="modal-title" id="myModalLabel">Anda yakin ingin membatalkan penambahan Data Produk?</h5>
          </div>
